...
if __name__ == "__main__":
    if USE_RUST:
        ...
        path_to_dll = r"D:\Licence\ALgo_Machie\Projet\2020-3A-IABD1-Correction_modele_lineaire\out\build\x64-Debug (par défaut)\2020_3A_IABD1_Correction_modele_lineaire.dll"
