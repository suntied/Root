...
path_file_img_movie_action = r"D:\Licence\ALgo_Machie\Projet\2020_3A_IABD2_Correction_Modele_Lineaire_Python\Dataset\DatasetAction"
path_file_img_movie_comedy = r"D:\Licence\ALgo_Machie\Projet\2020_3A_IABD2_Correction_Modele_Lineaire_Python\Dataset\DatasetComedy"
extension = [".png"]
images_action = []
...
for element in os.listdir(path_file_img_movie_action):
    ...
    image = tf.keras.preprocessing.image.load_img(os.path.join(path_file_img_movie_action,element),
                                                  grayscale=False,
                                                  target_size=(32,32),
...
for element in os.listdir(path_file_img_movie_comedy):
    ext = os.path.splitext(element)[1]
    if ext.lower() not in extension:
        continue
    # image = Image.open(os.path.join(path_file_img_movie_action,element))
    ...
    image = tf.keras.preprocessing.image.load_img(os.path.join(path_file_img_movie_comedy, element),
                                                  grayscale=False,
                                                  target_size=(32, 32),
                                                  interpolation='nearest')
    ...
    # images_action.append(array.flatten())
    # ToDo add another class to get 3 values 1,-1,-1
    images_comedy_class.append(np.array([1, -1]))
